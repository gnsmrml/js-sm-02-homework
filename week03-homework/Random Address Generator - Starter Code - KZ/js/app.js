$(document).ready(function(){
	...
	// excellent work on this! ... one thing to challenge yourself might be to take the process of generating random numbers and make that into a function
	// that maybe takes the array and generates a random number OR maybe takes a range (min, max)
