$(document).ready(function(){
	...
	$('input#makeLetter').click(function(){
		...
		// great job! good structure and organization.. you can see here how labor intensive something like this is... we can use loops, foreach and other iterators to makethis a little less cumbersome.
